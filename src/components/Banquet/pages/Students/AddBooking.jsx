...
//   useEffect(() => {
//     if (form.pax && form.ratePlan && form.foodType) {
...
//       }
//     } else {
//       // Clear total and ratePerPax if required fields are missing
//       setForm((prev) => ({
//         ...prev,
//         total: "",
//         ratePerPax: "",
//       }));
//     }
//   }, [form.pax, form.ratePlan, form.foodType, form.gst, form.discount, form.decorationCharge, form.musicCharge, form.hasDecoration, form.hasMusic]);
...
//         `${import.meta.env.VITE_BACKEND_URL}/api/banquet-bookings/create`,
//         payload
//       );
